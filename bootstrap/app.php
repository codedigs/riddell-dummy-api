...
$app->middleware([
   ...
   App\Http\Middleware\DelayRequestMiddleware::class
]);
...
$app->routeMiddleware([
    ...
    'valid_to_use_cart_for_non_session' => App\Http\Middleware\ValidToUseCartForNonSessionMiddleware::class,
